private function register_get_stats(): void {
    wp_register_ability( 'ninja-portfolio/get-stats', [
        'label'       => __( 'Estadísticas del portfolio', 'ninja-portfolio' ),
        'description' => __( 'Devuelve estadísticas generales del portfolio: total de proyectos, desglose por categoría y años.', 'ninja-portfolio' ),
...
public function execute_get_stats(): array {
    ...
    return [
        ...
        'by_year'     => [], // Se puede ampliar con una query GROUP BY sobre post_meta
    ];
}
