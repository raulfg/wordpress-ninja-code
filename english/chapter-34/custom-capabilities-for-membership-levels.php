// Define membership capabilities
...
// Assign capability when a membership is activated
function ninja_activate_membership( int $user_id, string $plan ): void {
    ...
    // Save start date and active plan
...
// Revoke membership (on expiry or cancellation)
