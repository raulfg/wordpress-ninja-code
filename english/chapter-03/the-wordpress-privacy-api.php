    ...
    if ( $user ) {
        ...
        foreach ( $submissions as $post_id ) {
            $data[] = [
                ...
                'group_label' => __( 'Portfolio submissions', 'ninja-portfolio' ),
                'item_id'     => "submission-{$post_id}",
                'data'        => [
                    [ 'name' => __( 'Title', 'ninja-portfolio' ), 'value' => get_the_title( $post_id ) ],
                    [ 'name' => __( 'Date', 'ninja-portfolio' ), 'value' => get_the_date( '', $post_id ) ],
                ],
            ];
        }
    }
