...
function ninja_handle_stripe_webhook( WP_REST_Request $request ): WP_REST_Response|WP_Error {
    ...
    try {
        ...
        return new WP_Error( 'invalid_signature', 'Firma de webhook inválida.', [ 'status' => 400 ] );
    }
    ...
    // 3. Responder inmediatamente con 200
    // Stripe reintenta si no recibe 200 en 30 segundos
