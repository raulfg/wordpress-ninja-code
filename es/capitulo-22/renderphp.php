 ...
 *   $content    — contenido de Inner Blocks (vacío en este bloque)
...
// get_block_wrapper_attributes() genera class, style, id y demás atributos
// que WordPress añade según los `supports` declarados en block.json.
