add_action( 'wp_enqueue_scripts', function(): void {
    ...
    // Pasar datos del contexto actual al script
    $current_category = '';
    ...
    wp_add_inline_script(
        ...
        'window.ninjaPortfolio = ' . wp_json_encode( [
            ...
            'perPage'         => 12,
            'i18n'            => [
                'loading'  => __( 'Cargando proyectos...', 'ninjatheme' ),
                'noMore'   => __( 'Has llegado al final.', 'ninjatheme' ),
                'error'    => __( 'Error al cargar proyectos.', 'ninjatheme' ),
                'loadMore' => __( 'Cargar más', 'ninjatheme' ),
            ],
        ] ),
        'before'
    );
