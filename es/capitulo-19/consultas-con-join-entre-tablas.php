/**
 * Obtiene proyectos destacados con su categoría principal.
 *
 * @return array Array de objetos con post_id, title, client, category_name.
 */
function ninja_get_featured_with_category(): array {
    ...
    return $wpdb->get_results( $wpdb->prepare(
        "SELECT
         ...
         -- Metadato del cliente
         LEFT JOIN {$wpdb->postmeta} pm
             ON pm.post_id  = p.ID
             AND pm.meta_key = '_npe_client_name'

         -- Taxonomía: portfolio-category
         ...
         -- Solo posts destacados y publicados
